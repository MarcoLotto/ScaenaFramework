...
Release_Library_Path=-L"..//Graphics/Release" -L"..//Graphics/WindowConnectors/Release"

# Additional libraries...
Debug_Libraries=-Wl,--start-group -lGraphics -lWindowConnector -lGLEW -lGLU -lGL -lX11 -lpthread -lm -lrt -ldl -Wl,--end-group
