...
public:
	...
	// Devuelve la cantidad de veces que se invoco a un metodo de Device
	int getMethodCalls(string methodName);

	// Devuelve toda la info de invocacion a metodos
	map<string, int>* getMethodsInfo(){
