...
RenderPipeline* RenderPipelineBuilder::getRenderPipelineConfigForward(UIController* uiController, Scene* scene){
...
ForwardGeometryStage* RenderPipelineBuilder::getGeometryForwardStage(UIController* uiController, Scene* scene, RenderPipelineWithGeometryAndBackWrite* pipeline){
...
RenderPipeline* RenderPipelineBuilder::getRenderPipelineConfigForwardAndBloom(UIController* uiController, Scene* scene){
	// Configuro el render pipeline
	RenderPipelineWithGeometryAndBackWrite* renderPipelineImp = new RenderPipelineWithGeometryAndBackWrite();
...
RenderPipeline* RenderPipelineBuilder::getRenderPipelineConfigDeferred(UIController* uiController, Scene* scene){
	// Configuro el render pipeline
	RenderPipelineWithGeometryAndBackWrite* renderPipelineImp = new RenderPipelineWithGeometryAndBackWrite();
...
// El forward geometry stage se utiliza para renderizar geometria en una sola etapa (es decir la iluminacion se produce en el mismo shader de geometria)
DeferredGeometryStage* RenderPipelineBuilder::getGeometryDeferredStage(UIController* uiController, Scene* scene, RenderPipelineWithGeometryAndBackWrite* pipeline){
	vec2 size = uiController->getScreenSize();
...
RenderPipeline* RenderPipelineBuilder::getRenderPipelineConfigDeferredAndDepthOfField(UIController* uiController, Scene* scene, bool nearDepthActive){
	// Configuro el render pipeline
	RenderPipelineWithGeometryAndBackWrite* renderPipelineImp = new RenderPipelineWithGeometryAndBackWrite();
...
RenderPipeline* RenderPipelineBuilder::getRenderPipelineConfigDeferredAndSSAO(UIController* uiController, Scene* scene){
	// Configuro el render pipeline
	RenderPipelineWithGeometryAndBackWrite* renderPipelineImp = new RenderPipelineWithGeometryAndBackWrite();
...
DepthOfFieldStage* RenderPipelineBuilder::getDepthofFieldStage(DeferredGeometryStage* geometryStage, BackBufferWriterStage* lastStage, vec2 size, bool nearDepthActive){
...
RenderPipeline* RenderPipelineBuilder::getRenderPipelineConfigForwardAndBlur(UIController* uiController, Scene* scene){
	// Configuro el render pipeline
	RenderPipelineWithGeometryAndBackWrite* renderPipelineImp = new RenderPipelineWithGeometryAndBackWrite();
...
RenderPipeline* RenderPipelineBuilder::getRenderPipelineConfigForwardAndUI(UIController* uiController, Scene* scene){
	// Configuro el render pipeline
	RenderPipelineWithGeometryAndBackWrite* renderPipelineImp = new RenderPipelineWithGeometryAndBackWrite();
