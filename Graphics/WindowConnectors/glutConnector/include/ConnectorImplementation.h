...
#include "glWindow.h"
   ...
   //! \ingroup app
   class ConnectorImplementation : public glWindow
   {
   public:
      ConnectorImplementation(void);
      virtual ~ConnectorImplementation(void);
   ...
   protected:   
      static std::list<ConnectorImplementation*> _gWinInstances;
